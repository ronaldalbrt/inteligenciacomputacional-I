module Lista1
    ...
    function plot_data(n::Int64=50)
        ...
        plot!(x_1_negative, x_2_negative, label="Dados de Treino (y = 0)", seriestype=:scatter, color=:indianred)
        ...
        plot!(x_1_negative_test, x_2_negative_test, label="Dados de Teste (y = 0)", seriestype=:scatter, color=:red)
